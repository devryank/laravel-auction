...
<div class="bg-gray-200 bg-opacity-25 dark:bg-gray-800 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 dark:text-gray-200 leading-7 font-semibold"><a
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 dark:text-gray-200 leading-7 font-semibold">Authentication</div>
        </div>
